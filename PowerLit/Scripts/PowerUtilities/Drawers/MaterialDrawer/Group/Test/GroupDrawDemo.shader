Shader "Unlit/GroupDrawDemo"
{
    Properties
    {
        ...
        // remap slider
        [GroupSlider(group1)]
        _GroupSlider("_GroupSlider",range(0.1,0.5)) = 0.2
        ...
        // vector slider
        [GroupVectorSlider(group1,a b c d,0_1 1_2 0_1 0_2)]
        _Vector("_Vector",vector) = (1,1,1,1)
        [GroupVectorSlider(group1,Dir(xyz) intensity, 0_1)]
         _Vector2("_Vector2", vector) = (1,0.1,0,1)
