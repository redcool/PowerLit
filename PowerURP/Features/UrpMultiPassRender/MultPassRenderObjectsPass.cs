...
{
    public class MultPassRenderObjectsPass : ScriptableRenderPass
    {
        ...
        public MultPassRenderObjectsPass(string profilerTag, RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, int layerMask, RenderObjects.CustomCameraSettings cameraSettings)
        {
            base.profilingSampler = new ProfilingSampler(nameof(MultPassRenderObjectsPass));
        ...
        //internal RenderObjectsMultiPass(URPProfileId profileId, RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, int layerMask, RenderObjectsManager.CustomCameraSettings cameraSettings)
